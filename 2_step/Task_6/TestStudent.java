...
public class TestStudent
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Отсортированный массив по id вставки");
        for (Student s : students)
        {
            System.out.println(s);
        }
        ...
        // Быстрая по GPA
        System.out.println();
        System.out.println("Отсортированный массив по баллам");
        ...
        System.out.println("Неотсортированный массив 2 сортировкой");
        ...
        System.out.println("Отсортированные и соединенные массивы 1 и 2 слиянием");
